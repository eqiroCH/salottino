              ...
              >
                <div className="aspect-square relative img-zoom">
                  ...
                  <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-sm px-3 py-1.5">
                    <span className="text-sm font-medium text-primary">{basket.size}</span>
                  </div>
                </div>
                
                <div className="p-8 flex flex-col flex-1">
                  <div className="flex items-baseline justify-between mb-4">
                    <h3 className="font-display text-2xl text-primary">{basket.name}</h3>
                    <span className="text-accent font-semibold text-sm">{basket.priceRange}</span>
                  </div>
                  ...
                  <div className="pt-5 border-t border-border/50 flex-1 flex flex-col">
                    ...
                    <a 
                      ...
                      className="inline-flex items-center gap-2 bg-accent hover:bg-accent/90 text-white px-6 py-3 font-medium rounded-lg transition-all hover:shadow-md hover:scale-[1.02] w-full justify-center mt-auto"
                    >
