          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="space-y-12">
                ...
                <div className="flex-1">
                  <div className="grid md:grid-cols-3 gap-8 items-start">
                    <div className="md:col-span-1">
                      <h3 className="font-display text-xl text-primary mb-4">{tCommon('address')}</h3>
                    ...
                    <div className="relative md:col-span-2">
                      ...
                      >
                        <div className="relative w-full h-48 rounded-lg overflow-hidden border border-border/30 hover:border-accent/60 transition-all duration-300 shadow-sm hover:shadow-lg">
                          <iframe
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h3 className="font-display text-xl text-primary mb-3">{tCommon('phone')}</h3>
                  <a href="tel:+41446832022" className="text-foreground hover:text-accent transition-colors block">
                    +41 44 683 20 22
                  </a>
                  <a href="tel:+41793745427" className="text-muted-foreground hover:text-accent transition-colors block mt-1">
                    Mobile: +41 79 374 54 27
                  </a>
                  <p className="text-sm text-muted-foreground mt-2">{t('emergency')}</p>
                </div>
              </div>

              {/* WhatsApp */}
              <div className="flex items-start gap-5">
                <svg className="w-6 h-6 text-accent shrink-0 mt-1" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div>
                  <h3 className="font-display text-xl text-primary mb-3">WhatsApp</h3>
                  <a 
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h3 className="font-display text-xl text-primary mb-3">{tCommon('email')}</h3>
                  <a href="mailto:eva.vogel@salottino.ch" className="text-foreground hover:text-accent transition-colors">
              ...
              <div className="flex items-start gap-5">
                ...
                <div className="flex-1">
                  <h3 className="font-display text-xl text-primary mb-4">{tCommon('openingHours')}</h3>
